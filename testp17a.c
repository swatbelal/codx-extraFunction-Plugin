...
#define PLUGIN_HANDLER_VERSION_MAJOR_A 2
#define PLUGIN_HANDLER_VERSION_MINOR_A 302

PCL void OnInfoRequest(pluginInfo_t *info){	// Function used to obtain information about the plugin
    // Memory pointed by info is allocated by the server binary, just fill in the fields

    // =====  MANDATORY FIELDS  =====
    info->handlerVersion.major = PLUGIN_HANDLER_VERSION_MAJOR_A;
    info->handlerVersion.minor = PLUGIN_HANDLER_VERSION_MINOR_A;	// Requested handler version
